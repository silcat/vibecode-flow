...
1. 读 `docs/work/registry.md` "当前激活"，定位计划目录
2. 读 plan.md，找第一个 `status: in-progress` 的阶段
3. 找该阶段第一个未勾 checkbox，从该子任务开始执行
4. 阶段全部 checkbox 已勾 → 状态改为 `completed`，同步 registry
